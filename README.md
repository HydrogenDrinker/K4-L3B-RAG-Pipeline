...
- Mỗi thành viên nộp báo cáo cá nhân theo template trong `reports/INDIVIDUAL_REPORT.md` (hoặc `group_project/individual/`).
...
- [Individual report](reports/INDIVIDUAL_REPORT.md): template báo cáo cá nhân (hoặc trong `group_project/individual/`).
